    ...
    <section id="servicios" className="py-24 px-4 max-w-6xl mx-auto">
      <div className="text-center mb-16">
        <h2 className="text-4xl font-black  mb-4">
          Mis <span className="text-blueL hover:drop-shadow-[0_0_20px_rgb(0,255,247,0.5)] transition-all duration-400 drop-shadow-[0_0_15px_rgb(0,255,247,0.5)]">Servicios</span>
        </h2>
